<template>
  <div class="JA_wrap">
    <div class="home__container">
      ...
      <!--☆.｡.:*・ﾟ ☆.｡.:*・ﾟ ☆.｡.:*・ﾟ ☆.｡.:*・ﾟ ☆-->
              <div class="return_btn mobile">
      <router-link to="/">
        <img src="/image/return-cat.png" class="return_cat" alt=""/>
      </router-link>
    </div>
    </div>
    <div class="return_btn desk-top">
      <router-link to="/">
...
.text_selector-title,.text_selector-status  {
